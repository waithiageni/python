...
'IRENE'
>>> Balance=140000
>>> print("{}, confirmed received {}, from {}".format(code,balance,name))
Traceback (most recent call last):
  File "<pyshell#3>", line 1, in <module>
    print("{}, confirmed received {}, from {}".format(code,balance,name))
NameError: name 'balance' is not defined
>>> name="Irene"
>>> print("{} confirmed.\n hi {}, you balance is {}.\n Thankyou".format(code,name,balance))
Traceback (most recent call last):
...
>>> print("{} confirmed\n hi {} you balance is {}\n Thankyou".format(code,Name,Balance))
ABC123 confirmed
 hi Irene you balance is 140000
 Thankyou
>>> Print(sms)
Traceback (most recent call last):
...
>>> s.index("h")
6
>>> sms="ABCD123. confirmed !
SyntaxError: EOL while scanning string literal
>>> 
>>> sms='ABC123. confirmed!Hi Irene, you balance is 1000".
SyntaxError: EOL while scanning string literal
>>> sms='ABC123.confirmed!Hi Irene,you balance is 1000".
SyntaxError: EOL while scanning string literal
>>> sms='ABCD123.confirmed! Hi Irene,you balance is 1000".
SyntaxError: EOL while scanning string literal
>>> sms="ABCD123.confirmed! Hi Irene,you balance is 1000".
SyntaxError: invalid syntax
>>> sms="ABCD123.confirmed! Hi Irene,you balance is 1000."
...
'1000.'
>>> sms.upper()
'ABCD123.CONFIRMED! HI IRENE,YOU BALANCE IS 1000.'
>>> sms.lower()
'abcd123.confirmed! hi irene,you balance is 1000.'
>>> sms.capitalize()
'Abcd123.confirmed! hi irene,you balance is 1000.'
...
>>> sms.endswith(".")
True
>>> sms.replace("140000","500000")
'ABCD123.confirmed! Hi Irene,you balance is 1000.'
>>> sms.replace("1000","10000")
'ABCD123.confirmed! Hi Irene,you balance is 10000.'
>>> len(sms)
48
>>> len(s)
9
...
help> or summary contain a given string such as "spam", type "modules spam".
No Python documentation found for 'or summary contain a given string such as "spam", type "modules spam".'.
...
Traceback (most recent call last):
  File "<pyshell#135>", line 1, in <module>
    keywo
NameError: name 'keywo' is not defined
>>> 
>>> help()
